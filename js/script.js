...
function initSidebarHighlighting() {
    ...
    if (path.includes('Dashboard.php') || path.includes('DB-Notices-Archive.php')) {
        activeModuleId = '#nav-dashboard';
    } 
    // The following pages belong to the 'Applicants' module
    else if (path.includes('Applicants.php') || 
             path.includes('Applicant-Details.php') ||
             path.includes('ViewDocuments.php') ||
             path.includes('Evaluation.php')) {
        activeModuleId = '#nav-applicants';
    } 
    else if (path.includes('InterviewStatus.php')) {
        activeModuleId = '#nav-interview';
    } 
    // The following pages belong to the 'Settings' module
    else if (path.includes('Settings.php') || path.includes('StaffList.php')) {
